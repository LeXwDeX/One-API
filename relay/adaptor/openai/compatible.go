...
import (
	"github.com/LeXwDeX/one-api/relay/adaptor/ai360"
	"github.com/LeXwDeX/one-api/relay/adaptor/alibailian"
	"github.com/LeXwDeX/one-api/relay/adaptor/baichuan"
	"github.com/LeXwDeX/one-api/relay/adaptor/baiduv2"
	"github.com/LeXwDeX/one-api/relay/adaptor/deepseek"
	"github.com/LeXwDeX/one-api/relay/adaptor/doubao"
	"github.com/LeXwDeX/one-api/relay/adaptor/geminiv2"
	"github.com/LeXwDeX/one-api/relay/adaptor/groq"
	"github.com/LeXwDeX/one-api/relay/adaptor/lingyiwanwu"
	"github.com/LeXwDeX/one-api/relay/adaptor/minimax"
	"github.com/LeXwDeX/one-api/relay/adaptor/mistral"
	"github.com/LeXwDeX/one-api/relay/adaptor/moonshot"
	"github.com/LeXwDeX/one-api/relay/adaptor/novita"
	"github.com/LeXwDeX/one-api/relay/adaptor/openrouter"
	"github.com/LeXwDeX/one-api/relay/adaptor/siliconflow"
	"github.com/LeXwDeX/one-api/relay/adaptor/stepfun"
	"github.com/LeXwDeX/one-api/relay/adaptor/togetherai"
	"github.com/LeXwDeX/one-api/relay/adaptor/xai"
	"github.com/LeXwDeX/one-api/relay/adaptor/xunfeiv2"
